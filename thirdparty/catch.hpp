...
#define INTERNAL_CATCH_TYPE_GEN                                               \
    ...
    struct rewrap<TemplateTypeList<Container>, List<Elems...>, Elements...> { \
        using type = typename append<                                         \
                ...
                typename rewrap<TemplateTypeList<Container>, Elements...>::   \
                        type>::type;                                          \
    };                                                                        \
                                                                              \
    template <                                                                \
...
namespace Catch { namespace Benchmark {
template <typename Duration>
struct Estimate {
    Duration point;
    ...
    auto cli
            ...
            | Opt(config.benchmarkWarmupTime,
                  "benchmarkWarmupTime")["--benchmark-warmup-time"](
                      "amount of time in milliseconds spent on warming up each "
                      "test (default: 100)")
